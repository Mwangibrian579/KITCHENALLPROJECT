  ...
  return (
    <div className="group bg-white border border-slate-200 rounded-lg overflow-hidden hover:border-orange-500 hover:shadow-2xl transition-all duration-300">
      ...
      <div className="p-5">
        ...
        <h3 className="font-bold text-slate-900 text-lg mt-1 group-hover:text-orange-600 transition-colors truncate">
          {product.name}
        </h3>
        
        <p className="text-slate-500 text-sm mt-2 line-clamp-2 min-h-[40px] leading-snug">
          {product.description || "High-performance equipment designed for professional durability and efficiency."}
        </p>
        ...
        <div className="mt-6 pt-4 border-t border-slate-50 flex items-end justify-between">
          ...
          {/* Add to Cart Button */}
          <button className="bg-slate-100 text-slate-900 p-3 rounded-md hover:bg-orange-600 hover:text-white transition-all shadow-sm">
